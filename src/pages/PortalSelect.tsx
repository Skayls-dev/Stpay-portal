      ...
      <div className="w-full max-w-xl">
        ...
        <Link to="/demo/webshop"
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--green)] mb-1">
                Demo Publique
              </p>
              <h2 className="font-extrabold text-[16px] text-[var(--text-1)] mb-2 tracking-tight">
                Webshop Checkout ST Pay
              </h2>
              <p className="text-[12px] text-[var(--text-2)] leading-relaxed">
                Experience decouplee pour demontrer l'integration checkout d'un e-commerce avec ST Pay.
              </p>
            </div>
            <span className="st-badge st-badge-success">Public</span>
          </div>
          <div className="mt-4 flex items-center gap-1 text-[11px] text-[var(--green)] font-semibold
                          opacity-0 group-hover:opacity-100 transition-opacity">
            Ouvrir la demo
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
              <path d="M2.5 6h7M6.5 3l3 3-3 3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
